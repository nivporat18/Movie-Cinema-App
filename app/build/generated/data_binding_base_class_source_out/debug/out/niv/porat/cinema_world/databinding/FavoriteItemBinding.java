...
public final class FavoriteItemBinding implements ViewBinding {
  ...
  private FavoriteItemBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnRemove,
      @NonNull ImageView imageSlide, @NonNull TextView title) {
  ...
  public static FavoriteItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FavoriteItemBinding((ConstraintLayout) rootView, btnRemove, imageSlide, title);
    }
