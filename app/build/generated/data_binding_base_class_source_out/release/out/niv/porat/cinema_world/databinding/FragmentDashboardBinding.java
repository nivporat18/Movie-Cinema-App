...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvRatedMovie;
  ...
  private FragmentDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView rvPopularMovie, @NonNull RecyclerView rvRatedMovie,
      @NonNull ScrollView scrollView3, @NonNull TextView textView2, @NonNull TextView textView4) {
    this.rootView = rootView;
    this.rvPopularMovie = rvPopularMovie;
    this.rvRatedMovie = rvRatedMovie;
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.rv_popularMovie;
      RecyclerView rvPopularMovie = ViewBindings.findChildViewById(rootView, id);
      if (rvPopularMovie == null) {
        break missingId;
      }

      id = R.id.rv_ratedMovie;
      RecyclerView rvRatedMovie = ViewBindings.findChildViewById(rootView, id);
      if (rvRatedMovie == null) {
        break missingId;
      }
      ...
      return new FragmentDashboardBinding((ConstraintLayout) rootView, rvPopularMovie, rvRatedMovie,
          scrollView3, textView2, textView4);
    }
